	...
	public function render_ai_model_field() {
		...
		if ( '' !== $effective && false === WA_AI::model_supports_drafting( $provider, $effective ) ) {
			...
			printf(
				...
				esc_html__( 'Heads up: %s does not advertise support for the structured JSON responses drafting requires. Drafting with it is likely to fail — choose a model that supports JSON/structured output.', 'wellactually' ),
